...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("\nDADOS DO MOTORISTA");
        System.out.println("Nome do motorista: " + carro.getMotorista().getNome());
        ...
        System.out.println("E-mail do motorista: " + carro.getMotorista().getEmail());
